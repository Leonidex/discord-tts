...
* @param {boolean} cfg.useBase64Method
*/
function getVoiceStream(text, { lang = 'en', slow = false, host = 'https://translate.google.com', timeout = 10000, splitPunct, useBase64Method = true } = {}) {
  const stream = new Stream.PassThrough();
  downloadFromInfoCallback(stream, text, { lang, slow, host, timeout, splitPunct, useBase64Method });
  return stream;
}
